...
<Column field="Details" header="Details" body={pTemplate1} filter={selectedFilterFields.includes("Details")} hidden={selectedHideFields?.includes("Details")}  sortable style={{ minWidth: "8rem" }} />
